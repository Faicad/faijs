...
| English | 中文 | Notes |
|---|---|---|
| BREP | BREP | Boundary representation model via exact geometric operations (OCCT solid) |
| mesh | mesh | Triangulated mesh path (manifold-3d) |
| manifold | manifold | manifold-3d mesh engine |
| OCCT | OCCT | OpenCascade Technology |
