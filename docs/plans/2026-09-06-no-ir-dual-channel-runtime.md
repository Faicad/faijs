...
状态：已落地（P1–P6 全部完成：MetadataExtractor + DirectExecutor + computeLiveShapes + CadRuntime direct 模式 + 多文件引擎侧 + 缺省翻转 + IR 代码删除。T1–T5 全部交付，对拍门禁 A-16/A-17/A-14 转为 direct-only 行为快照，typecheck/lint/守卫/全量测试绿。）
