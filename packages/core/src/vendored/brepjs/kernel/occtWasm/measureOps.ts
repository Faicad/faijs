...
/**
 * Result of {@link surfaceCurvature} — kept shape-identical to the upstream
 * `kernel/occt/measureOps.CurvatureResult` (that module is cut per the layered
 * plan; the ported measurement layer re-exports this type).
 */
