// source: test_free_functions.py::test_moved (var s2)
// ref (cadquery 2.8.0): vol 0.002094, 4 faces, com (0,0,0.5)
//   s2 = s.moved(b.edges('|Z'))  -> 4 spheres at the vertical edge midpoints
...
let s2 = await cq.moved(sp, [cq.Location([-0.5, -0.5, 0.5]), cq.Location([-0.5, 0.5, 0.5]), cq.Location([0.5, -0.5, 0.5]), cq.Location([0.5, 0.5, 0.5])])
