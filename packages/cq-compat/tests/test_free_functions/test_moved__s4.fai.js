// source: test_free_functions.py::test_moved (var s4)
// ref (cadquery 2.8.0): vol 0.000524, 1 faces, com (0,0,0.5)
//   s4 = s.moved(b)  -> one sphere at the box centre (0,0,0.5)
...
let s4 = await cq.moved(sp, cq.Location([0, 0, 0.5]))
let result = cq.val(s4)
