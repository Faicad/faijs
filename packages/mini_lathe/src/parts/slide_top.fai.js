...
slide_top_wp = cq.cutBlind(cq.polygon(cq.center(cq.workplane(cq.faces(slide_top_wp, "-Y[1]"), { centerOption: "CenterOfBoundBox" }), 0, hex_center_z), 6, hexagon_out), (-4))
slide_top_wp = cq.cutBlind(cq.polygon(cq.center(cq.workplane(cq.faces(slide_top_wp, "+Y[1]"), { centerOption: "CenterOfBoundBox" }), 0, hex_center_z), 6, hexagon_out), (-4))
slide_top_wp = cq.hole(cq.center(cq.workplane(cq.faces(slide_top_wp, "+Y[1]"), { centerOption: "CenterOfBoundBox" }), 0, hex_center_z), 5.3)
