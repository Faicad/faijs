...
import { measureVolume, isValid, isSolid, getSolids, getEdges } from '@faicad/faijs/brepjs-compat';
...
import type { BendRule, ProfileSegment, SheetMetalPart } from './types.js';
