...
import { isOk, isErr, unwrap, measureVolume, isValid, getSolids, getEdges, curveStartPoint } from '@faicad/faijs/compat';
...
import { flatPatternToDXF } from './dxfFns.js';
import type { BendRule, FlatInput, SheetMetalPart } from './types.js';
