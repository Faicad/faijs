...
export function assertVec3(value, name) {
...
export function assertNonZeroVec3(value, name) {
...
export function assertNumberOrVec3(value, name) {
...
export function assertOneOf(value, name, allowed) {
