...
import { drawRectangle, drawCircle, getKernel } from '../p5-surface.js';
import {
  reverseCurve,
  curve2dBoundingBox,
  curve2dFirstPoint,
  ...
  curve2dIsOnCurve,
  curve2dDistanceFrom,
} from '@faicad/faijs-core/vendored/brepjs/2d/lib/curve2dFns.js';
import { intersectCurves } from '@faicad/faijs-core/vendored/brepjs/2d/lib/intersections.js';
