...
import { initKernel, currentKernel } from '../kernel-setup.js';
import {
  box,
  cylinder,
  cut,
...
import {
  ...
  scaleTransform2d,
  transformCurves,
} from '@faicad/faijs-core/vendored/brepjs/2d/curves.js';
import { Curve2D } from '@faicad/faijs-core/vendored/brepjs/2d/lib/index.js';
import { getKernel } from '@faicad/faijs-core/vendored/brepjs/kernel/index.js';
