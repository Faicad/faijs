...
import { configureBackends, CONTRACT_VERSION, BrepUnsupportedError } from '@faicad/faijs-core/runtime-state'
import type { Backends } from '@faicad/faijs-core/runtime-state'
import { dispatchPath as sdkDispatchPath } from '@faicad/faijs-core/sdk'
import { dispatchPath as internalDispatchPath } from '@faicad/faijs-core/cad-runtime/backend-dispatch'
