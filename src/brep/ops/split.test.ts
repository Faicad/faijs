 ...
 *
 * Run: npx vitest run src/brep/ops/split.test.ts
 */
...
import { fileBlobStore } from '../../runtime/blob-store'
...
beforeAll(async () => {
  ...
  const stepPath = resolve(__dirname, '..', '..', '..', 'src', 'test', 'fixtures', 'box_boss.step')
